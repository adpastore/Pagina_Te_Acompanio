...
#catalogo = Catalogo(host='carlosrosselli.mysql.pythonanywhere-services.com', user='carlosrosselli', password='Grupo#12python', database='carlosrosselli$miapp')
catalogo = Catalogo(host='carlosrosselli.mysql.pythonanywhere-services.com', user='carlosrosselli', password='Grupo#12', database='carlosrosselli$miapp')
